...
Game::Game()
{
    ...
    material = Material(Texture("/Users/ashishgogna/Desktop/Projects/GameEngine/GameEngine/Resources/Textures/Checker.bmp"), Vector3(1, 1, 1), 1, 8);
    transform = Transform();
    ...
    static_cast<PhongShader*>(shader)->directionalLight = DirectionalLight(BaseLight(Vector3(1, 1, 1), 0.2), Vector3(1, 1, 1));
}
